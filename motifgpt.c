...
void populate_settings_dialog() {
    ...
    XmToggleButtonSetState(disable_history_limit_toggle, (Boolean)history_limits_disabled, False);
    XmToggleButtonSetState(enter_sends_message_toggle, (Boolean)enter_key_sends_message, False);

    XmTextSetString(system_prompt_text, current_system_prompt);
    XmToggleButtonSetState(append_prompt_toggle, (Boolean)append_default_system_prompt, False);
