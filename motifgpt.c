...
Widget create_provider_settings_tab(Widget, const char*, Widget*, const char*, Widget*, const char*, Widget*, Widget*, const char*, int);
...
Widget create_provider_settings_tab(Widget parent, const char *prefix,
    ...
    *model_list_w = XmCreateScrolledList(tab, name_buffer, NULL, 0);
    XtVaSetValues(XtParent(*model_list_w),
                  XmNtopAttachment, XmATTACH_WIDGET, XmNtopWidget, get_models_btn, XmNtopOffset, 5,
                  XmNleftAttachment, XmATTACH_FORM,
                  XmNrightAttachment, XmATTACH_FORM,
...
void settings_callback(Widget w, XtPointer client_data, XtPointer call_data) {
    if (settings_shell == NULL) {
        ...
        settings_gemini_tab_content = create_provider_settings_tab(content_frame, "gemini",
                                                                   &gemini_api_key_text, DEFAULT_GEMINI_KEY_PLACEHOLDER,
                                                                   &gemini_model_text, DEFAULT_GEMINI_MODEL,
                                                                   &gemini_model_list,
                                                                   NULL, NULL,
                                                                   0);

        settings_openai_tab_content = create_provider_settings_tab(content_frame, "openai",
                                                                   &openai_api_key_text, DEFAULT_OPENAI_KEY_PLACEHOLDER,
                                                                   &openai_model_text, DEFAULT_OPENAI_MODEL,
                                                                   &openai_model_list,
                                                                   &openai_base_url_text, DEFAULT_OPENAI_BASE_URL,
                                                                   1);

        settings_anthropic_tab_content = create_provider_settings_tab(content_frame, "anthropic",
                                                                      &anthropic_api_key_text, DEFAULT_ANTHROPIC_KEY_PLACEHOLDER,
                                                                      &anthropic_model_text, DEFAULT_ANTHROPIC_MODEL,
