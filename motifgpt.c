...
static void flush_token_buffer(char *buf, size_t *len) {
    if (*len > 0) {
        append_to_conversation(buf);
        buf[0] = '\0';
        *len = 0;
    }
}
